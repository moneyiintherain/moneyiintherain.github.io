...
const questions = [
    ...
    {
        id: 1,
        question: '  Գրիգոր Զոհրապի ո՞ր նովելից է հետևյալ խոսքերը. <br>«Հանդիսատեսներ պետք է ասոնցպեսներուն, ու կյանքը հրապույր չունի, եթե զիրենք դիտողները պակսին»։',
        flaseAnswer1: '«Զաբուղոն»',
        flaseAnswer2: '«Այինկա»',
        flaseAnswer3: '«Ճիտին պարտքը»',
        trueAnswer: '«Երջանիկ մահը»'
    },
    {
        id: 2,
    ...
    {
        id: 5,
        question: 'Լրացնել բաց թողնված բառը.<br>Հոն ժըպտեցաւ կեանքը ինծի,        <br>Հըմայքներու հոյլովն անցաւ,<br>Եւ __________ մը կասկածի         <br>Անոր մօտէն երբեք չանցաւ:',
        flaseAnswer1: 'թովչանք',
        trueAnswer: 'ուրվական',
        flaseAnswer2: 'միտքը',
        flaseAnswer3: 'սարսուռ'
    },
    {
        id: 6,
    ...
    {
        id: 7,
        question: 'Ավետիք Իսահակյանի ո՞ր բանաստեղծությունից են հետևյալ տողերը.<br>«Հայրենիքես հեռացել եմ,<br>Խեղճ պանդուխտ եմ, տուն չունիմ»:',
        flaseAnswer1: '«Հայրենիքիս»',
        flaseAnswer2: '«Իմ աղորքը»',
        trueAnswer: '«Մայրիկիս»',
        flaseAnswer3: '«Մեր պատմիչներն և մեր գուսաններ»'
    },
    {
        id: 8,
    ...
    {
        id: 16,
        question: 'Նշել հեղինակի ազգանունը<br>Դու պիտի ծաղկիս, երկիր հայրական,<br>Քո ոգով, ոճով և բարձրագլուխ,<br>Դու պիտի հնչես, հնչես հաղթական,<br>Իմ հին հայ լեզու՝ քա՛ղցր ու սրտաբո՛ւխ։',
        flaseAnswer1: 'Թումանյան',
